...
const DoubleRoom = ({ rooms: { double_rooms } }) =>
  <div className="light">
    ...
    <div className="room_text">
      ...
      <p>&nbsp;</p>
      <h3>203, 206 — двухместные номера с двумя односпальными кроватями ( с возможностью сдвига). Площадь 23-25 кв.м.&nbsp;<br/>202, 205 — двухместные номера с двуспальной кроватью евро. Площадь 23-25 кв.м.&nbsp;</h3>
      <p>&nbsp;</p>
